            ...
            <div className="relative">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                ...
                <div className="relative flex justify-center">
                  {/* Стрелка слева */}
                  <div className="hidden md:block absolute left-0 top-1/2 -translate-y-1/2 -translate-x-20">
                  ...
                  {/* Стрелка справа */}
                  <div className="hidden md:block absolute right-0 top-1/2 -translate-y-1/2 translate-x-20">
                    <ArrowRight className="w-8 h-8 text-primary animate-pulse" />
                  </div>
                </div>
